import bookAvater from "../assets/book.png";
import starAvater from "../assets/star.svg";
      ...
      {books.map((book) => (
        <div className="space-y-3" key={book.id}>
          <div className="flex items-center justify-center rounded-md border border-[#324251]/30 bg-white p-4">
            <img className="max-w-[144px]" src={book.avater} alt={book.name} />
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3 text-xs lg:text-sm">
              ...
              <button
                ...
                className={` ${
                  !book.isFavourite
                    ? "flex min-w-[132px] items-center justify-center gap-1 rounded-md bg-[#1C4336] py-1.5 text-white transition-all hover:opacity-80 lg:py-1.5"
